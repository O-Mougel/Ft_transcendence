		...
		return `
			...
			<div class="text-center ml-auto mr-auto pt-[5%]">
				...
				<form>
					...
					<div class="">
						<input tabindex="3" class="uppercase text-sm md:text-base xl:text-2xl text-white focus:outline-none focus:border-[#98c6f8] hover:text-[#98c6f8] text-ellipsis w-1/2 md:w-1/4 border hover:border-[#98c6f8] border-white pt-2 pb-2 rounded-lg shadow-[0_0_20px_rgba(158,202,237,0.9)] " name="login" type="submit" value="Sign In">
					</div>
				</form>
			</div>`
	}
