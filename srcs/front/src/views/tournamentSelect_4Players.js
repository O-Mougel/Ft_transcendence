	...
	async getHTML() {
		...
		<div class="h-full w-full">
			<form id="tournamentForm4Players" class="mt-[5vw]">
					<input id="player1" tabindex="1" class="w-[50vw] mt-[1vw] pl-5 mx-auto hover:text-[#98c6f8]  focus:outline-none focus:border-[#98c6f8] hover:border-[#98c6f8]-[35px] rounded-sm border border-[#c2dbf6]" type="text" autofocus autocomplete="off" placeholder="Player 1">
					<input id="player2" tabindex="2" class="w-[50vw] mt-[1vw] pl-5 mx-auto hover:text-[#98c6f8]  focus:outline-none focus:border-[#98c6f8] hover:border-[#98c6f8]-[35px] rounded-sm border border-[#c2dbf6]" type="text" autocomplete="off" placeholder="Player 2">
