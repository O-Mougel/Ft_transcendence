	...
	async getHTML() {
		...
		<div class="h-full w-full">
			<form id="tournamentForm8Players" class="pt-[5vw]">
				...
				<div class="">
						<input tabindex="9" class="w-[20vw] mt-[1vw] h-[4vw] focus:outline-none focus:border-[#98c6f8] hover:text-[#98c6f8] border hover:border-[#98c6f8] border-white rounded-lg " name="start4Players" type="submit" value="Start" onclick="get8PlayerName(event)">
				</div>
			</form>
		</div>`
	}
