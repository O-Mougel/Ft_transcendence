...
export default class extends ViewTemplate {
	...
	async getHTML() {
		return `
			<div id="profilePanel" class="flex absolute right-0 top-0 h-full min-w-80 w-[20%] bg-[url(/img/stars.gif)] z-50 shadow-[0_0_20px_rgba(158,202,237,0.9)] border border-[#98c6f8]">
			...
			<div class="h-full w-full">
				<form id="tournamentForm8Players" class="pt-[5vw]">
					...
					<div class="">
							<input tabindex="9" class="shadow-[0_0_20px_rgba(158,202,237,0.9)] w-[20vw] mt-[1vw] h-[4vw] focus:outline-none focus:border-[#98c6f8] hover:text-[#98c6f8] border hover:border-[#98c6f8] border-white rounded-lg " name="start4Players" type="submit" value="Start" onclick="get8PlayerName(event)">
					</div>
				</form>
			</div>`
	}
