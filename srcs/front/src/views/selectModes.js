			...
			<div class="h-[93%] w-full grow basis-full">
				<div class="h-full w-full flex">
					...
					<div class="flex-1 rounded-xl">
						...
						<div class="flex-1 h-1/2 rounded-xl box-border border-10 bg-[url(/img/vsUnlogged2.png)] bg-cover grayscale-85 hover:grayscale-0 blur-[5px] hover:blur-[0px] transition duration-400 ease-in-out  flex items-center justify-center" href="/pong"></div>
					</div>
				</div>
			</div>
		</div>`
