...
export default class StartingFileView extends ViewTemplate {
	constructor() {
		super();
		...
		return `
			<div id="profilePanel" class="hidden absolute animate-slide-in-left right-0 top-0 h-full min-w-80 w-[35%] max-w-[640px] bg-[url(/img/assets/stars.gif)] z-50 shadow-[0_0_20px_rgba(158,202,237,0.9)] border border-[#98c6f8] overflow-auto">
				<div class="flex flex-col text-center w-full h-full">
					...
					<h1 id="playerGrabbedUsername" class="text-black text-bold text-ellipsis underline mx-4 mb-10 text-2xl lg:text-4xl "></h1>
			...
			<div class="pt-[5vw] h-full w-full">
				<h1 id="bigMainTitle" class="text-center mx-auto text-[5vw] sm:text-[5vw] 2xl:text-[4vw] w-[80%] my-6 animate-wiggle" onclick="ft_bh()">FT_Transcendence</h1>
